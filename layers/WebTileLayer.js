...
define(["require","exports","../core/tsSupport/assignHelper","../core/tsSupport/declareExtendsHelper","../core/tsSupport/decorateHelper","dojo/string","../geometry","../request","../core/Error","../core/lang","../core/MultiOriginJSONSupport","../core/promiseUtils","../core/urlUtils","../core/urlUtils","../core/accessorSupport/decorators","./Layer","./mixins/OperationalLayer","./mixins/PortalLayer","./mixins/RefreshableLayer","./mixins/ScaleRangeLayer","./support/commonProperties","./support/LOD","./support/TileInfo"],function(e,t,r,l,o,n,i,p,a,s,u,c,y,d,f,v,m,h,w,g,b,T,S){return function(t){function r(e,r){var l=t.call(this)||this;return l.copyright="",l.fullExtent=new i.Extent(-20037508.342787,-20037508.34278,20037508.34278,20037508.342787,i.SpatialReference.WebMercator),l.legendEnabled=!0,l.popupEnabled=!0,l.spatialReference=i.SpatialReference.WebMercator,l.subDomains=null,l.tileInfo=new S({size:256,dpi:96,format:"PNG8",compressionQuality:0,origin:new i.Point({x:-20037508.342787,y:20037508.342787,spatialReference:i.SpatialReference.WebMercator}),spatialReference:i.SpatialReference.WebMercator,lods:[new T({level:0,scale:591657527.591555,resolution:156543.033928}),new T({level:1,scale:295828763.795777,resolution:78271.5169639999}),new T({level:2,scale:147914381.897889,resolution:39135.7584820001}),new T({level:3,scale:73957190.948944,resolution:19567.8792409999}),new T({level:4,scale:36978595.474472,resolution:9783.93962049996}),new T({level:5,scale:18489297.737236,resolution:4891.96981024998}),new T({level:6,scale:9244648.868618,resolution:2445.98490512499}),new T({level:7,scale:4622324.434309,resolution:1222.99245256249}),new T({level:8,scale:2311162.217155,resolution:611.49622628138}),new T({level:9,scale:1155581.108577,resolution:305.748113140558}),new T({level:10,scale:577790.554289,resolution:152.874056570411}),new T({level:11,scale:288895.277144,resolution:76.4370282850732}),new T({level:12,scale:144447.638572,resolution:38.2185141425366}),new T({level:13,scale:72223.819286,resolution:19.1092570712683}),new T({level:14,scale:36111.909643,resolution:9.55462853563415}),new T({level:15,scale:18055.954822,resolution:4.77731426794937}),new T({level:16,scale:9027.977411,resolution:2.38865713397468}),new T({level:17,scale:4513.988705,resolution:1.19432856685505}),new T({level:18,scale:2256.994353,resolution:.597164283559817}),new T({level:19,scale:1128.497176,resolution:.298582141647617})]}),l.type="web-tile",l.urlTemplate=null,l}return l(r,t),r.prototype.normalizeCtorArgs=function(e,t){return"string"==typeof e?s.mixin({urlTemplate:e},t||{}):e},r.prototype.load=function(){var e=this,t=this.loadFromPortal({supportedTypes:["WMTS"]}).then(function(){if(!e.urlTemplate)throw new a("layer:load","WebTileLayer (title: '"+e.title+"', id: '"+e.id+"') is missing the required 'urlTemplate' property value")});return this.addResolvingPromise(t),this.when()},Object.defineProperty(r.prototype,"levelValues",{get:function(){var e=[];if(!this.tileInfo)return null;for(var t=0,r=this.tileInfo.lods;t<r.length;t++){var l=r[t];e[l.level]=l.levelValue||l.level}return e},enumerable:!0,configurable:!0}),r.prototype.readSpatialReference=function(e,t){return e||t.fullExtent&&t.fullExtent.spatialReference&&i.SpatialReference.fromJSON(t.fullExtent.spatialReference)},Object.defineProperty(r.prototype,"tileServers",{get:function(){if(!this.urlTemplate)return null;var e=[],t=this,r=t.urlTemplate,l=t.subDomains,o=new y.Url(r),n=o.scheme?o.scheme+"://":"//",i=n+o.authority+"/";if(-1===o.authority.indexOf("{subDomain}"))e.push(i);else if(l&&l.length>0&&o.authority.split(".").length>1)for(var p=0,a=l;p<a.length;p++){var s=a[p];e.push(n+o.authority.replace(/\{subDomain\}/gi,s)+"/")}return e.map(function(e){return"/"!==e.charAt(e.length-1)&&(e+="/"),e})},enumerable:!0,configurable:!0}),Object.defineProperty(r.prototype,"urlPath",{get:function(){if(!this.urlTemplate)return null;var e=this.urlTemplate,t=new y.Url(e),r=(t.scheme?t.scheme+"://":"//")+t.authority+"/";return e.substring(r.length)},enumerable:!0,configurable:!0}),r.prototype.readUrlTemplate=function(e,t){return e||t.templateUrl},r.prototype.writeUrlTemplate=function(e,t,r){e&&d.isProtocolRelative(e)&&(e="https:"+e),t.templateUrl=e?d.normalize(e):e},r.prototype.fetchTile=function(e,t,r,l){var o=this.getTileUrl(e,t,r),n={responseType:"image"};return l&&l.timestamp&&(n.query={_ts:l.timestamp}),p(o,n).then(function(e){return e.data})},r.prototype.getTileUrl=function(e,t,r){var l=this.levelValues[e],o=this.tileServers[t%this.tileServers.length]+n.substitute(this.urlPath,{level:l,col:r,row:t});return o=o.replace(/\{level\}/gi,""+l).replace(/\{row\}/gi,""+t).replace(/\{col\}/gi,""+r)},r.prototype.importLayerViewModule=function(t){switch(t.type){case"2d":return c.create(function(t){return e(["../views/2d/layers/TileLayerView2D"],t)});case"3d":return c.create(function(t){return e(["../views/3d/layers/TileLayerView3D"],t)})}},o([f.property({type:String,value:"",json:{write:!0}})],r.prototype,"copyright",void 0),o([f.property({type:i.Extent,json:{write:!0}})],r.prototype,"fullExtent",void 0),o([f.property(b.legendEnabled)],r.prototype,"legendEnabled",void 0),o([f.property({type:["show","hide"]})],r.prototype,"listMode",void 0),o([f.property({dependsOn:["tileInfo"]})],r.prototype,"levelValues",null),o([f.property({type:["WebTiledLayer"],value:"WebTiledLayer"})],r.prototype,"operationalLayerType",void 0),o([f.property(b.popupEnabled)],r.prototype,"popupEnabled",void 0),o([f.property({type:i.SpatialReference})],r.prototype,"spatialReference",void 0),o([f.reader("spatialReference",["spatialReference","fullExtent.spatialReference"])],r.prototype,"readSpatialReference",null),o([f.property({type:[String],json:{write:!0}})],r.prototype,"subDomains",void 0),o([f.property({type:S,json:{write:!0}})],r.prototype,"tileInfo",void 0),o([f.property({readOnly:!0,dependsOn:["urlTemplate","subDomains"]})],r.prototype,"tileServers",null),o([f.property({json:{read:!1}})],r.prototype,"type",void 0),o([f.property({dependsOn:["urlTemplate"]})],r.prototype,"urlPath",null),o([f.property({type:String,json:{origins:{"portal-item":{read:{source:"url"}}}}})],r.prototype,"urlTemplate",void 0),o([f.reader("urlTemplate",["urlTemplate","templateUrl"])],r.prototype,"readUrlTemplate",null),o([f.writer("urlTemplate",{templateUrl:{type:String}})],r.prototype,"writeUrlTemplate",null),o([f.property({json:{write:!0}})],r.prototype,"wmtsInfo",void 0),r=o([f.subclass("esri.layers.WebTileLayer")],r)}(f.declared(v,m,u,g,h,w))});