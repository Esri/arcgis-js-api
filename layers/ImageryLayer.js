...
define(["require","dojo/_base/lang","../core/promiseUtils","./Layer","./mixins/ArcGISImageService","./mixins/OperationalLayer","./mixins/PortalLayer","./mixins/ScaleRangeLayer","./mixins/RefreshableLayer","./support/commonProperties"],function(e,r,a,i,n,s,t,o,l,c){var d={canvas2D:"2d",webGL:"webgl",expWebGL:"experimental-webgl",webGL2:"webgl2",expWebGL2:"experimental-webgl2"};return i.createSubclass([n,s,t,o,l],{declaredClass:"esri.layers.ImageryLayer",normalizeCtorArgs:function(e,a){return"string"==typeof e?r.mixin({},{url:e},a):e},load:function(){this.addResolvingPromise(this.loadFromPortal({supportedTypes:["Image Service"]}).always(this._fetchService.bind(this)))},properties:{drawMode:!0,drawType:{value:d.canvas2D,cast:function(e){return e in d?e:d.canvas2D}},legendEnabled:{json:{read:{source:["showLegend"],reader:function(e,r){return null==r.showLegend||r.showLegend}},write:function(e,r){r.showLegend=!!e}}},operationalLayerType:"ArcGISImageServiceLayer",popupEnabled:c.popupEnabled,pixelFilter:null,type:{value:"imagery",json:{read:!1}}},redraw:function(){this.emit("redraw")},importLayerViewModule:function(r){switch(r.type){case"2d":return a.create(function(r){e(["../views/2d/layers/ImageryLayerView2D"],r)});case"3d":return a.create(function(r){e(["../views/3d/layers/ImageryLayerView3D"],r)})}}})});