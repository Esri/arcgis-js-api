...
define(["dojo/_base/lang","dojo/io-query","../request","../core/urlUtils","../core/promiseUtils","../geometry/SpatialReference","./TiledLayer","./mixins/ArcGISMapService","./mixins/ArcGISCachedService","./mixins/OperationalLayer","./mixins/PortalLayer","./mixins/RefreshableLayer","./mixins/ScaleRangeLayer","./support/arcgisLayers","./support/arcgisLayerUrl"],function(e,r,i,t,s,a,n,o,l,c,p,u,h,d,g){return n.createSubclass([o,l,h,c,p,u],{declaredClass:"esri.layers.TileLayer",_mapsWithAttribution:["Canvas/World_Dark_Gray_Base","Canvas/World_Dark_Gray_Reference","Canvas/World_Light_Gray_Base","Canvas/World_Light_Gray_Reference","Elevation/World_Hillshade","Ocean/World_Ocean_Base","Ocean/World_Ocean_Reference","Ocean_Basemap","Reference/World_Boundaries_and_Places","Reference/World_Boundaries_and_Places_Alternate","Reference/World_Transportation","World_Imagery","World_Street_Map","World_Topo_Map"],_TILE_FORMATS:{PNG:"png",PNG8:"png",PNG24:"png",PNG32:"png",JPG:"jpg",JPEG:"jpg",GIF:"gif"},_attributionServices:["services.arcgisonline.com/arcgis/rest/services","servicesdev.arcgisonline.com/arcgis/rest/services","servicesqa.arcgisonline.com/arcgis/rest/services"],normalizeCtorArgs:function(r,i){return"string"==typeof r?e.mixin({},{url:r},i):r},load:function(){return this.addResolvingPromise(this.loadFromPortal({supportedTypes:["Image Service","Map Service"]}).always(this._fetchService.bind(this))),this.when()},properties:{operationalLayerType:{get:function(){if(this.capabilities)return-1!==this.capabilities.indexOf("Map")?"ArcGISTiledMapServiceLayer":"ArcGISTiledImageServiceLayer";var e=this.url||this.portalItem&&this.portalItem.url;return e&&/\/ImageServer(\/|\/?$)/i.test(e)?"ArcGISTiledImageServiceLayer":"ArcGISTiledMapServiceLayer"}},attributionDataUrl:{dependsOn:["parsedUrl"],get:function(){return this._getDefaultAttribution(this._getMapName(this.parsedUrl.path.toLowerCase()))}},popupTemplates:null,tileServers:{dependsOn:["parsedUrl"],value:null,cast:function(e){return Array.isArray(e)?e.map(function(e){return t.urlToObject(e).path}):null},get:function(){return this._getDefaultTileServers(this.parsedUrl.path)}},url:{json:{origins:{"web-scene":{write:{isRequired:!0,ignoreOrigin:!0,writer:t.writeOperationalLayerUrl}}}}},type:{value:"tile",json:{read:!1}},spatialReference:{json:{read:{source:["spatialReference","tileInfo"],reader:function(e,r){return(e=e||r.tileInfo&&r.tileInfo.spatialReference)&&a.fromJSON(e)}}}}},getTileUrl:function(e,i,t){var s=this.tileServers,a=this.parsedUrl.query?r.objectToQuery(this.parsedUrl.query):"";this.token&&(a=a+(a?"&":"")+"token="+encodeURIComponent(this.token)),this.resampling&&!this.tilemapCache&&this.supportsBlankTile&&(a=a+(a?"&":"")+"blankTile=false"),this.refreshTimestamp&&(a=a+(a?"&":"")+"_ts="+this.refreshTimestamp);var n=(s&&s.length?s[i%s.length]:this.parsedUrl.path)+"/tile/"+e+"/"+i+"/"+t;return n+=a?"?"+a:""},_fetchService:function(){return s.resolve().then(function(){return this.resourceInfo||i(this.parsedUrl.path,{query:e.mixin({f:"json"},this.parsedUrl.query),responseType:"json",callbackParamName:"callback"})}.bind(this)).then(function(e){if(e.ssl&&(this.url=this.url.replace(/^http:/i,"https:")),this.read(e.data,{origin:"service",url:this.parsedUrl}),10.1===this.version&&!g.isHostedAgolService(this.url))return d.fetchServerVersion(this.url).then(function(e){this.read({currentVersion:e})}.bind(this)).catch(function(){})}.bind(this))},_getMapName:function(e){var r=e.match(/^(?:https?:)?\/\/(server|services)\.arcgisonline\.com\/arcgis\/rest\/services\/([^\/]+(\/[^\/]+)*)\/mapserver/i);return r&&r[2]},_getDefaultAttribution:function(e){if(e){var r;e=e.toLowerCase();for(var i=0,s=this._mapsWithAttribution.length;i<s;i++)if(r=this._mapsWithAttribution[i],r.toLowerCase().indexOf(e)>-1)return t.makeAbsolute("//static.arcgis.com/attribution/"+r)}},_getDefaultTileServers:function(e){var r=-1!==e.search(/^(?:https?:)?\/\/server\.arcgisonline\.com/i),i=-1!==e.search(/^(?:https?:)?\/\/services\.arcgisonline\.com/i);return r||i?[e,e.replace(r?/server\.arcgisonline/i:/services\.arcgisonline/i,r?"services.arcgisonline":"server.arcgisonline")]:[]}})});