...
define(["require","exports","../core/tsSupport/assignHelper","../core/tsSupport/declareExtendsHelper","../core/tsSupport/decorateHelper","dojo/io-query","../geometry","../request","../core/promiseUtils","../core/urlUtils","../core/accessorSupport/decorators","./Layer","./mixins/ArcGISCachedService","./mixins/ArcGISMapService","./mixins/OperationalLayer","./mixins/PortalLayer","./mixins/RefreshableLayer","./mixins/ScaleRangeLayer","./mixins/SublayersOwner","./support/arcgisLayers","./support/arcgisLayerUrl"],function(e,r,t,a,i,o,n,s,l,p,c,u,y,d,f,v,h,g,m,_,S){var b=["Canvas/World_Dark_Gray_Base","Canvas/World_Dark_Gray_Reference","Canvas/World_Light_Gray_Base","Canvas/World_Light_Gray_Reference","Elevation/World_Hillshade","Ocean/World_Ocean_Base","Ocean/World_Ocean_Reference","Ocean_Basemap","Reference/World_Boundaries_and_Places","Reference/World_Boundaries_and_Places_Alternate","Reference/World_Transportation","World_Imagery","World_Street_Map","World_Topo_Map"];return function(r){function u(e,t){var a=r.call(this)||this;return a.spatialReference=null,a.sublayers=null,a.type="tile",a.url=null,a}return a(u,r),u.prototype.normalizeCtorArgs=function(e,r){return"string"==typeof e?t({url:e},r):e},u.prototype.load=function(){var e=this;return this.addResolvingPromise(this.loadFromPortal({supportedTypes:["Image Service","Map Service"]}).always(function(){return e._fetchService()})),this.when()},Object.defineProperty(u.prototype,"attributionDataUrl",{get:function(){return this._getDefaultAttribution(this._getMapName(this.parsedUrl.path.toLowerCase()))},enumerable:!0,configurable:!0}),Object.defineProperty(u.prototype,"operationalLayerType",{get:function(){if(this.capabilities)return this.capabilities.operations.supportsExportMap?"ArcGISTiledMapServiceLayer":"ArcGISTiledImageServiceLayer";var e=this.url||this.portalItem&&this.portalItem.url;return e&&/\/ImageServer(\/|\/?$)/i.test(e)?"ArcGISTiledImageServiceLayer":"ArcGISTiledMapServiceLayer"},enumerable:!0,configurable:!0}),u.prototype.readSpatialReference=function(e,r){return(e=e||r.tileInfo&&r.tileInfo.spatialReference)&&n.SpatialReference.fromJSON(e)},Object.defineProperty(u.prototype,"tileServers",{get:function(){return this._getDefaultTileServers(this.parsedUrl.path)},enumerable:!0,configurable:!0}),u.prototype.castTileServers=function(e){return Array.isArray(e)?e.map(function(e){return p.urlToObject(e).path}):null},u.prototype.fetchTile=function(e,r,t,a){var i=this.getTileUrl(e,r,t),o={responseType:"image"};return a&&a.timestamp&&(o.query={_ts:a.timestamp}),s(i,o).then(function(e){return e.data})},u.prototype.getTileUrl=function(e,r,a){var i=!this.tilemapCache&&this.supportsBlankTile,n=o.objectToQuery(t({},this.parsedUrl.query,{blankTile:!i&&null,token:this.token?encodeURIComponent(this.token):null})),s=this.tileServers;return(s&&s.length?s[r%s.length]:this.parsedUrl.path)+"/tile/"+e+"/"+r+"/"+a+(n?"?"+n:"")},u.prototype.importLayerViewModule=function(r){switch(r.type){case"2d":return l.create(function(r){return e(["../views/2d/layers/TileLayerView2D"],r)});case"3d":return l.create(function(r){return e(["../views/3d/layers/TileLayerView3D"],r)})}},u.prototype._fetchService=function(){var e=this;return l.create(function(r,a){if(e.resourceInfo){return void r({data:e.resourceInfo})}s(e.parsedUrl.path,{query:t({f:"json"},e.parsedUrl.query),responseType:"json"}).then(r,a)}).then(function(r){if(r.ssl&&(e.url=e.url.replace(/^http:/i,"https:")),e.read(r.data,{origin:"service",url:e.parsedUrl}),10.1===e.version&&!S.isHostedAgolService(e.url))return _.fetchServerVersion(e.url).then(function(r){e.read({currentVersion:r})}).catch(function(){})})},u.prototype._getMapName=function(e){var r=e.match(/^(?:https?:)?\/\/(server|services)\.arcgisonline\.com\/arcgis\/rest\/services\/([^\/]+(\/[^\/]+)*)\/mapserver/i);return r&&r[2]},u.prototype._getDefaultAttribution=function(e){if(e){var r;e=e.toLowerCase();for(var t=0,a=b.length;t<a;t++)if(r=b[t],r.toLowerCase().indexOf(e)>-1)return p.makeAbsolute("//static.arcgis.com/attribution/"+r)}},u.prototype._getDefaultTileServers=function(e){var r=-1!==e.search(/^(?:https?:)?\/\/server\.arcgisonline\.com/i),t=-1!==e.search(/^(?:https?:)?\/\/services\.arcgisonline\.com/i);return r||t?[e,e.replace(r?/server\.arcgisonline/i:/services\.arcgisonline/i,r?"services.arcgisonline":"server.arcgisonline")]:[]},i([c.property({readOnly:!0,dependsOn:["parsedUrl"]})],u.prototype,"attributionDataUrl",null),i([c.property({readOnly:!0})],u.prototype,"operationalLayerType",null),i([c.property()],u.prototype,"popupTemplates",void 0),i([c.property({type:n.SpatialReference})],u.prototype,"spatialReference",void 0),i([c.reader("spatialReference",["spatialReference","tileInfo"])],u.prototype,"readSpatialReference",null),i([c.property()],u.prototype,"resourceInfo",void 0),i([c.property({readOnly:!0})],u.prototype,"sublayers",void 0),i([c.property({dependsOn:["parsedUrl"],readOnly:!0})],u.prototype,"tileServers",null),i([c.cast("tileServers")],u.prototype,"castTileServers",null),i([c.property({readOnly:!0,json:{read:!1}})],u.prototype,"type",void 0),i([c.property({json:{origins:{"web-scene":{write:{isRequired:!0,ignoreOrigin:!0,writer:p.writeOperationalLayerUrl}}}}})],u.prototype,"url",void 0),u=i([c.subclass("esri.layers.TileLayer")],u)}(c.declared(u,m.default,d,y,g,f,v,h))});