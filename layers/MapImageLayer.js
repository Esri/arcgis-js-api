...
define(["require","exports","../core/tsSupport/assignHelper","../core/tsSupport/declareExtendsHelper","../core/tsSupport/decorateHelper","../core/tsSupport/paramHelper","../core/tsSupport/generatorHelper","../core/tsSupport/awaiterHelper","../request","../core/Error","../core/maybe","../core/MultiOriginJSONSupport","../core/promiseUtils","../core/accessorSupport/decorators","../geometry/Extent","../geometry/support/scaleUtils","./Layer","./mixins/ArcGISMapService","./mixins/ArcGISService","./mixins/OperationalLayer","./mixins/PortalLayer","./mixins/RefreshableLayer","./mixins/ScaleRangeLayer","./mixins/SublayersOwner","./mixins/TemporalLayer","./support/commonProperties","./support/ExportImageParameters"],function(e,r,t,o,a,i,p,n,s,l,u,y,c,d,m,g,h,v,f,S,x,b,w,I,L,M,O){return function(r){function y(e,t){var o=r.call(this)||this;return o.alwaysRefetch=!1,o.dpi=96,o.gdbVersion=null,o.imageFormat="png24",o.imageMaxHeight=2048,o.imageMaxWidth=2048,o.imageTransparency=!0,o.labelsVisible=!1,o.isReference=null,o.operationalLayerType="ArcGISMapServiceLayer",o.sourceJSON=null,o.sublayers=null,o.type="map-image",o.url=null,o}return o(y,r),y.prototype.normalizeCtorArgs=function(e,r){return"string"==typeof e?t({url:e},r):e},y.prototype.load=function(e){var r=this,t=u.isSome(e)?e.signal:null;return this.addResolvingPromise(this.loadFromPortal({supportedTypes:["Map Service"]},e).then(function(){return r._fetchService(t)})),this.when()},y.prototype.readImageFormat=function(e,r){var t=r.supportedImageFormatTypes;return t&&t.indexOf("PNG32")>-1?"png32":"png24"},y.prototype.createExportImageParameters=function(e,r,o,a){var i=a&&a.pixelRatio||1;e&&this.version>=10&&(e=e.clone().shiftCentralMeridian());var p=new O.ExportImageParameters({layer:this,scale:g.getScale({extent:e,width:r})*i}),n=p.toJSON();p.layer=null,p.destroy();var s=!a||!a.rotation||this.version<10.3?{}:{rotation:-a.rotation},l=e&&e.spatialReference,u=l.wkid||JSON.stringify(l.toJSON());n.dpi*=i;var y={};if(a&&a.timeExtent){var c=a.timeExtent.toJSON(),d=c.start,m=c.end;d&&m&&d===m?y.time=""+d:null==d&&null==m||(y.time=(null==d?"null":d)+","+(null==m?"null":m))}return t({bbox:e&&e.xmin+","+e.ymin+","+e.xmax+","+e.ymax,bboxSR:u,imageSR:u,size:r+","+o},n,s,y)},y.prototype.fetchImage=function(e,r,o,a){var i={responseType:"image"};a&&a.timestamp&&(i.query={_ts:a.timestamp}),a&&a.signal&&(i.signal=a.signal);var p,n,u=this.getImageUrl(e,r,o,a);if(u)n=c.when(u).then(function(e){return p=e,s(p,i)});else{p=this.parsedUrl.path+"/export";var y=t({},this.parsedUrl.query,this.createExportImageParameters(e,r,o,a),{f:"image",_ts:this.alwaysRefetch?Date.now():null});if(null!=y.dynamicLayers&&!this.capabilities.exportMap.supportsDynamicLayers)return c.reject(new l("mapimagelayer:dynamiclayer-not-supported","service "+this.url+" doesn't support dynamic layers, which is required to be able to change the sublayer's order, rendering, labeling or source.",{query:y}));i.query?i.query=t({},y,i.query):i.query=y,n=s(p,i)}return n.then(function(e){return e.data}).catch(function(e){if(c.isAbortError(e))throw e;throw new l("mapimagelayer:image-fetch-error","Unable to load image: "+p,{error:e})})},y.prototype.getImageUrl=function(e,r,t,o){return null},y.prototype.importLayerViewModule=function(r){return n(this,void 0,void 0,function(){return p(this,function(t){switch(r.type){case"2d":return[2,c.create(function(r){return e(["../views/2d/layers/MapImageLayerView2D"],r)})];case"3d":return[2,c.create(function(r){return e(["../views/3d/layers/MapImageLayerView3D"],r)})]}return[2]})})},y.prototype._fetchService=function(e){return n(this,void 0,void 0,function(){var r,o,a;return p(this,function(i){switch(i.label){case 0:return this.sourceJSON?(this.read(this.sourceJSON,{origin:"service",url:this.parsedUrl}),[2]):[4,s(this.parsedUrl.path,{query:t({f:"json"},this.parsedUrl.query),signal:e})];case 1:return r=i.sent(),o=r.data,a=r.ssl,a&&(this.url=this.url.replace(/^http:/i,"https:")),this.sourceJSON=o,this.read(o,{origin:"service",url:this.parsedUrl}),[2]}})})},a([d.property()],y.prototype,"alwaysRefetch",void 0),a([d.property()],y.prototype,"dpi",void 0),a([d.property()],y.prototype,"gdbVersion",void 0),a([d.property({json:{read:!1,write:!1}})],y.prototype,"popupEnabled",void 0),a([d.property()],y.prototype,"imageFormat",void 0),a([d.reader("imageFormat",["supportedImageFormatTypes"])],y.prototype,"readImageFormat",null),a([d.property({json:{origins:{service:{read:{source:"maxImageHeight"}}}}})],y.prototype,"imageMaxHeight",void 0),a([d.property({json:{origins:{service:{read:{source:"maxImageWidth"}}}}})],y.prototype,"imageMaxWidth",void 0),a([d.property()],y.prototype,"imageTransparency",void 0),a([d.property({json:{read:!1,write:!1}})],y.prototype,"labelsVisible",void 0),a([d.property({type:Boolean,json:{read:!1,write:{enabled:!0,overridePolicy:function(){return{enabled:!1}}}}})],y.prototype,"isReference",void 0),a([d.property({type:["ArcGISMapServiceLayer"]})],y.prototype,"operationalLayerType",void 0),a([d.property()],y.prototype,"sourceJSON",void 0),a([d.property()],y.prototype,"sublayers",void 0),a([d.property({type:["show","hide","hide-children"]})],y.prototype,"listMode",void 0),a([d.property({json:{read:!1},readOnly:!0,value:"map-image"})],y.prototype,"type",void 0),a([d.property(M.url)],y.prototype,"url",void 0),a([i(0,d.cast(m))],y.prototype,"getImageUrl",null),y=a([d.subclass("esri.layers.MapImageLayer")],y)}(d.declared(L.TemporalLayer(w.ScaleRangeLayer(b.RefreshableLayer(I.SublayersOwner(v.ArcGISMapService(f.ArcGISService(S.OperationalLayer(x.PortalLayer(y.MultiOriginJSONMixin(h)))))))))))});