...
define(["require","exports","../core/tsSupport/declareExtendsHelper","../core/tsSupport/decorateHelper","../core/accessorSupport/decorators","dojo/_base/lang","dojo/io-query","../core/promiseUtils","../config","../request","./DynamicLayer","./mixins/ArcGISDynamicMapService","./mixins/OperationalLayer","./mixins/PortalLayer"],function(e,r,t,o,a,n,p,i,s,l,c,d,u,y){var h=function(e){function r(r,t){var o=e.call(this)||this;return o.alwaysRefetch=!1,o.legendEnabled=!0,o.operationalLayerType="ArcGISMapServiceLayer",o.type="map-image",o}return t(r,e),r.prototype.normalizeCtorArgs=function(e,r){return"string"==typeof e?n.mixin({url:e},r):e},r.prototype.load=function(){var e=this;return this.addResolvingPromise(this.loadFromPortal({supportedTypes:["Map Service"]}).then(function(){return e._fetchService()})),this},r.prototype.readLegendEnabled=function(e,r){return null!=r.showLegend?r.showLegend:!0},r.prototype.writeLegendEnabled=function(e,r){r.showLegend=!!e},r.prototype.getImageUrl=function(e,r,t,o){var a=this,i=this.parsedUrl.path+"/export",c=n.mixin({},this.parsedUrl.query,this.createExportImageParameters(e,r,t,o),{f:"image",token:this.token,_ts:this.alwaysRefetch?(new Date).getTime():null}),d=i+"?"+p.objectToQuery(c);return d.length>s.request.maxUrlLength?(c.f="json",l(i,{query:c,responseType:"json",callbackParamName:"callback"}).then(function(e){return e.data.href+(a.token?"?token="+a.token:"")})):d},r.prototype._fetchService=function(){var e=this;return i.resolve().then(function(){return e.resourceInfo?{ssl:!1,data:e.resourceInfo}:l(e.parsedUrl.path,{query:n.mixin({f:"json"},e.parsedUrl.query),responseType:"json",callbackParamName:"callback"})}).then(function(r){r.ssl&&(e.url=e.url.replace(/^http:/i,"https:")),e.read(r.data,{origin:"service",url:e.parsedUrl})})},r}(a.declared(c,d,u,y));return o([a.property()],h.prototype,"alwaysRefetch",void 0),o([a.property({type:Boolean})],h.prototype,"legendEnabled",void 0),o([a.reader("legendEnabled",["showLegend"])],h.prototype,"readLegendEnabled",null),o([a.writer("legendEnabled")],h.prototype,"writeLegendEnabled",null),o([a.property()],h.prototype,"operationalLayerType",void 0),o([a.property({json:{read:!1},readOnly:!0,value:"map-image"})],h.prototype,"type",void 0),h=o([a.subclass("esri.layers.MapImageLayer")],h)});