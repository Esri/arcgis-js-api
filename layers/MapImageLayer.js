...
define(["require","exports","../core/tsSupport/declareExtendsHelper","../core/tsSupport/decorateHelper","../core/tsSupport/paramHelper","../core/accessorSupport/decorators","dojo/_base/lang","dojo/io-query","../core/Error","../core/promiseUtils","../geometry/Extent","../config","../request","./DynamicLayer","./mixins/ScaleRangeLayer","./mixins/ArcGISDynamicMapService","./mixins/OperationalLayer","./mixins/PortalLayer","./mixins/RefreshableLayer"],function(e,r,t,a,o,n,i,s,p,l,c,d,u,y,h,m,g,f,b){var v=function(e){function r(r,t){var a=e.call(this)||this;return a.alwaysRefetch=!1,a.legendEnabled=!0,a.operationalLayerType="ArcGISMapServiceLayer",a.type="map-image",a}return t(r,e),r.prototype.normalizeCtorArgs=function(e,r){return"string"==typeof e?i.mixin({url:e},r):e},r.prototype.load=function(){var e=this;return this.addResolvingPromise(this.loadFromPortal({supportedTypes:["Map Service"]}).then(function(){return e._fetchService()})),this},r.prototype.readLegendEnabled=function(e,r){return null!=r.showLegend?r.showLegend:!0},r.prototype.writeLegendEnabled=function(e,r){r.showLegend=!!e},r.prototype.getImageUrl=function(e,r,t,a){var o=this,n=this.parsedUrl.path+"/export",c=i.mixin({},this.parsedUrl.query,this.createExportImageParameters(e,r,t,a),{f:"image",token:this.token,_ts:this.alwaysRefetch?(new Date).getTime():null});if(null!=c.dynamicLayers&&-1===this.capabilities.indexOf("DynamicLayers"))return l.reject(new p("mapimagelayer:dynamiclayer-not-supported","service "+this.url+" doesn't support dynamic layers, which is required to be able to change the sublayer's order, rendering, labeling or source.",{query:c}));var y=n+"?"+s.objectToQuery(c);return y.length>d.request.maxUrlLength?(c.f="json",u(n,{query:c,responseType:"json",callbackParamName:"callback"}).then(function(e){return e.data.href+(o.token?"?token="+o.token:"")})):y},r.prototype._fetchService=function(){var e=this;return l.resolve().then(function(){return e.resourceInfo?{ssl:!1,data:e.resourceInfo}:u(e.parsedUrl.path,{query:i.mixin({f:"json"},e.parsedUrl.query),responseType:"json",callbackParamName:"callback"})}).then(function(r){r.ssl&&(e.url=e.url.replace(/^http:/i,"https:")),e.read(r.data,{origin:"service",url:e.parsedUrl})})},a([n.property()],r.prototype,"alwaysRefetch",void 0),a([n.property({type:Boolean})],r.prototype,"legendEnabled",void 0),a([n.reader("legendEnabled",["showLegend"])],r.prototype,"readLegendEnabled",null),a([n.writer("legendEnabled")],r.prototype,"writeLegendEnabled",null),a([n.property()],r.prototype,"operationalLayerType",void 0),a([n.property({json:{read:!1},readOnly:!0,value:"map-image"})],r.prototype,"type",void 0),a([o(0,n.cast(c))],r.prototype,"getImageUrl",null),r=a([n.subclass("esri.layers.MapImageLayer")],r)}(n.declared(y,m,g,f,b,h));return v});