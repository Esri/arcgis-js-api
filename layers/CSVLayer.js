...
define(["require","exports","../core/tsSupport/declareExtendsHelper","../core/tsSupport/decorateHelper","../core/tsSupport/assignHelper","../core/tsSupport/paramHelper","../geometry","../core/urlUtils","../core/accessorSupport/decorators","./FeatureLayer","./graphics/data/FeatureStoreCapabilities","./graphics/sources/CSVSource","../tasks/support/Query"],function(e,t,r,o,n,i,p,u,a,l,s,y,c){return function(e){function t(t,r){var o=e.call(this)||this;return o.delimiter=null,o.fields=null,o.latitudeField=null,o.locationType="coordinates",o.longitudeField=null,o.operationalLayerType="CSV",o.outFields=["*"],o.portalItem=null,o.spatialReference=p.SpatialReference.WGS84,o.source=null,o.type="csv",o}return r(t,e),t.prototype.normalizeCtorArgs=function(e,t){return"string"==typeof e?n({url:e},t):e},Object.defineProperty(t.prototype,"capabilities",{get:function(){return{data:{supportsAttachment:!1,supportsM:!1,supportsZ:!1},operations:{supportsCalculate:!1,supportsTruncate:!1,supportsValidateSql:!1,supportsAdd:!1,supportsDelete:!1,supportsEditing:!1,supportsQuery:!0,supportsResizeAttachments:!1,supportsUpdate:!1},query:s.queryCapabilities,queryRelated:{supportsCount:!1,supportsOrderBy:!1,supportsPagination:!1},editing:{supportsGeometryUpdate:!1,supportsGlobalId:!1,supportsRollbackOnFailure:!1,supportsUpdateWithoutM:!1,supportsUploadWithItemId:!1,supportsDeleteByAnonymous:!1,supportsDeleteByOthers:!1,supportsUpdateByAnonymous:!1,supportsUpdateByOthers:!1}}},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"hasService",{get:function(){return!1},enumerable:!0,configurable:!0}),t.prototype.readWebMapLabelsVisible=function(e,t){return null!=t.showLabels?t.showLabels:!!(t.layerDefinition&&t.layerDefinition.drawingInfo&&t.layerDefinition.drawingInfo.labelingInfo)},Object.defineProperty(t.prototype,"url",{set:function(e){this._set("url",e)},enumerable:!0,configurable:!0}),t.prototype.readUrl=function(e,t,r){return u.read(e,r)},t.prototype.writeUrl=function(e,t,r,o){e=u.write(e,o),t.url=e?u.normalize(e):e},t.prototype.createGraphicsSource=function(){var e=this,t=new y.default({delimiter:this.delimiter,fields:this.fields,latitudeField:this.latitudeField,longitudeField:this.longitudeField,spatialReference:this.spatialReference,url:this.url});return this._set("source",t),t.when(function(){return e.read({locationInfo:t.locationInfo,columnDelimiter:t.columnDelimiter},{origin:"service",url:e.parsedUrl}),t})},t.prototype.queryFeatures=function(e,t){var r=this;return this.load().then(function(){return r.source.queryFeatures(e||r.createQuery())}).then(function(e){if(e&&e.features)for(var t=0,o=e.features;t<o.length;t++){var n=o[t];n.layer=n.sourceLayer=r}return e})},t.prototype.queryFeaturesJSON=function(e,t){var r=this;return this.load().then(function(){return r.source.queryFeaturesJSON(e||r.createQuery())})},t.prototype.queryObjectIds=function(e,t){var r=this;return this.load().then(function(){return r.source.queryObjectIds(e||r.createQuery())})},t.prototype.queryFeatureCount=function(e,t){var r=this;return this.load().then(function(){return r.source.queryFeatureCount(e||r.createQuery())})},t.prototype.queryExtent=function(e,t){var r=this;return this.load().then(function(){return r.source.queryExtent(e||r.createQuery())})},t.prototype._verifyFields=function(){},t.prototype._verifySource=function(){},t.prototype._hasMemorySource=function(){return!0},o([a.property({readOnly:!0,dependsOn:["loaded"],json:{read:!1}})],t.prototype,"capabilities",null),o([a.property({type:String,json:{write:{target:"columnDelimiter"},read:{source:"columnDelimiter"}}})],t.prototype,"delimiter",void 0),o([a.property({json:{read:{source:"layerDefinition.fields"}}})],t.prototype,"fields",void 0),o([a.property({readOnly:!0})],t.prototype,"hasService",null),o([a.reader("web-map","labelsVisible",["layerDefinition.drawingInfo.labelingInfo","showLabels"])],t.prototype,"readWebMapLabelsVisible",null),o([a.property({type:String,json:{write:{target:"locationInfo.latitudeFieldName"},read:{source:"locationInfo.latitudeFieldName"}}})],t.prototype,"latitudeField",void 0),o([a.property({type:String,json:{write:{target:"locationInfo.locationType"},read:{source:"locationInfo.locationType"}}})],t.prototype,"locationType",void 0),o([a.property({type:String,json:{write:{target:"locationInfo.longitudeFieldName"},read:{source:"locationInfo.longitudeFieldName"}}})],t.prototype,"longitudeField",void 0),o([a.property()],t.prototype,"operationalLayerType",void 0),o([a.property()],t.prototype,"outFields",void 0),o([a.property({json:{read:!1,write:!1}})],t.prototype,"portalItem",void 0),o([a.property({json:{read:!1},cast:null,type:y.default,readOnly:!0})],t.prototype,"source",void 0),o([a.property({json:{read:!1},value:"csv",readOnly:!0})],t.prototype,"type",void 0),o([a.property({json:{write:!0}})],t.prototype,"url",null),o([a.reader("url")],t.prototype,"readUrl",null),o([a.writer("url")],t.prototype,"writeUrl",null),o([i(0,a.cast(c))],t.prototype,"queryFeatures",null),o([i(0,a.cast(c))],t.prototype,"queryFeaturesJSON",null),o([i(0,a.cast(c))],t.prototype,"queryObjectIds",null),o([i(0,a.cast(c))],t.prototype,"queryFeatureCount",null),o([i(0,a.cast(c))],t.prototype,"queryExtent",null),t=o([a.subclass("esri.layers.CSVLayer")],t)}(a.declared(l))});