...
define(["exports","../geometry/support/Ellipsoid","../views/3d/terrain/interfaces","../views/3d/webgl-engine/collections/Component/Material/ComponentTechniqueConfiguration","../views/3d/webgl-engine/collections/Component/Material/shader/ComponentData.glsl","../views/3d/webgl-engine/collections/Component/Material/shader/VertexDiscardByOpacity.glsl","../views/3d/webgl-engine/core/shaderLibrary/ForwardLinearDepth.glsl","../views/3d/webgl-engine/core/shaderLibrary/ShaderOutput","../views/3d/webgl-engine/core/shaderLibrary/Slice.glsl","../views/3d/webgl-engine/core/shaderLibrary/attributes/NormalAttribute.glsl","../views/3d/webgl-engine/core/shaderLibrary/attributes/TextureCoordinateAttribute.glsl","../views/3d/webgl-engine/core/shaderLibrary/attributes/VertexColor.glsl","../views/3d/webgl-engine/core/shaderLibrary/attributes/VertexNormal.glsl","../views/3d/webgl-engine/core/shaderLibrary/attributes/VertexPosition.glsl","../views/3d/webgl-engine/core/shaderLibrary/output/OutputDepth.glsl","../views/3d/webgl-engine/core/shaderLibrary/output/OutputHighlight.glsl","../views/3d/webgl-engine/core/shaderLibrary/output/ReadLinearDepth.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/ComputeMaterialColor.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/ComputeNormalTexture.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/ComputeShadingNormal.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/EvaluateSceneLighting.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/MainLighting.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/MultipassTerrainTest.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/PhysicallyBasedRenderingParameters.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/ReadBaseColorTexture.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/ReadShadowMap.glsl","../views/3d/webgl-engine/core/shaderLibrary/terrain/Overlay.glsl","../views/3d/webgl-engine/core/shaderLibrary/util/AlphaCutoff","../views/3d/webgl-engine/core/shaderLibrary/util/AlphaDiscard.glsl","../views/3d/webgl-engine/core/shaderLibrary/util/EllipsoidMode","../views/3d/webgl-engine/core/shaderModules/interfaces","../views/3d/webgl-engine/core/shaderModules/ShaderBuilder","../views/3d/webgl-engine/core/shaderModules/Texture2DPassUniform","../views/3d/webgl-engine/lib/TransparencyPassType"],(function(e,r,o,a,l,t,i,d,n,s,g,c,u,v,h,m,C,p,w,b,y,x,M,T,S,O,f,L,N,P,A,R,B,D){"use strict";function W(e){const o=new R.ShaderBuilder;o.include(v.VertexPosition,e),o.include(u.VertexNormal,e),o.include(c.VertexColor,e),o.include(g.TextureCoordinateAttribute,e),o.include(i.ForwardLinearDepth,e),o.include(l.ComponentData,e),o.include(N.DiscardOrAdjustAlphaDraw,e),o.include(n.SlicePass,e),o.include(S.ReadBaseColorTexture,e),o.include(t.VertexDiscardByOpacity,e);const{vertex:W,fragment:$}=o;e.pbrMode!==T.PBRMode.Normal&&e.pbrMode!==T.PBRMode.Schematic||(o.include(T.PhysicallyBasedRenderingParameters,e),e.hasNormalTexture&&o.include(w.ComputeNormalTexture,e));const j=e.output===d.ShaderOutput.Shadow||e.output===d.ShaderOutput.ShadowHighlight||e.output===d.ShaderOutput.ShadowExcludeHighlight;j&&e.componentData===l.ComponentDataType.Varying?W.code.add(A.glsl`#define discardShadows(castShadows) { if(!castShadows) { gl_Position = vec4(1e38, 1e38, 1e38, 1.0); return; } }`):W.code.add(A.glsl`#define discardShadows(castShadows) {}`);const E=e.integratedMeshMode===a.IntegratedMeshMode.ColorOverlay||e.integratedMeshMode===a.IntegratedMeshMode.ColorOverlayWithWater,z=E&&e.output===d.ShaderOutput.Color&&e.pbrMode===T.PBRMode.WaterOnIntegratedMesh;return E&&(o.include(y.EvaluateSceneLighting,e),o.include(f.OverlayIM,e),e.spherical?W.code.add(A.glsl`
  ...
  `),e.output===d.ShaderOutput.Alpha&&($.include(C.ReadLinearDepth),o.include(M.multipassTerrainTest,e),o.include(p.ComputeMaterialColor,e),E&&$.uniforms.add(new B.Texture2DPassUniform("ovColorTex",((e,r)=>f.getColorTexture(e,r)))),$.code.add(A.glsl`
      void main() {
    ...
    `)),e.output===d.ShaderOutput.Color&&($.include(C.ReadLinearDepth),o.include(M.multipassTerrainTest,e),o.include(p.ComputeMaterialColor,e),o.include(b.ComputeShadingNormal,e),o.include(y.EvaluateSceneLighting,e),e.receiveShadows?(o.include(O.ReadShadowMapPass,e),$.code.add(A.glsl`float evaluateShadow() {
return readShadowMap(vPositionWorldCameraRelative, linearDepth);
}`)):$.code.add(A.glsl`float evaluateShadow() { return 0.0; }`),E&&$.uniforms.add(new B.Texture2DPassUniform("ovColorTex",((e,r)=>f.getColorTexture(e,r)))),$.code.add(A.glsl`
      void main() {
        discardBySlice(vPositionWorldCameraRelative);
        ${e.hasMultipassTerrain?A.glsl`terrainDepthTest(gl_FragCoord, vPosition_view.z);`:""}
...
materialColor.rgb = mix(materialColor.rgb, vec3(1), snow);`)),$.code.add(A.glsl`
    ...
    `)),(e.output===d.ShaderOutput.Depth||j)&&(o.include(h.OutputDepth,e),$.code.add(A.glsl`void main() {
discardBySlice(vPositionWorldCameraRelative);
vec4 textureColor = readBaseColorTexture();
discardOrAdjustAlpha(textureColor);
outputDepth(linearDepth);
    ...
    `)),e.output===d.ShaderOutput.ObjectAndLayerIdColor&&o.fragment.code.add(A.glsl`
      void main() {
        ...
        ${E?A.glsl`gl_FragColor = getOverlayColorTexel(vtcOverlay);`:"outputObjectAndLayerIdColor();"}
      }
