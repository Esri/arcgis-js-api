...
outputDepth(linearDepth);
    ...
    `)),T}const S=Object.freeze({__proto__:null,attributeLocations:T,build:O});e.ComponentShader=S,e.attributeLocations=T,e.build=O}));
