...
*/
define(["exports","./_rollupPluginBabelHelpers","../views/3d/terrain/interfaces","../views/3d/webgl-engine/core/shaderLibrary/ScreenSpacePass.glsl","../views/3d/webgl-engine/core/shaderModules/FloatPassUniform","../views/3d/webgl-engine/core/shaderModules/IntegerPassUniform","../views/3d/webgl-engine/core/shaderModules/interfaces","../views/3d/webgl-engine/core/shaderModules/ShaderBuilder","../views/3d/webgl-engine/core/shaderModules/Texture2DPassUniform"],(function(e,r,n,a,s,o,i,t,l){"use strict";let d=function(e){function a(){var r;return(r=e.apply(this,arguments)||this).overlayIndex=n.OverlayIndex.INNER,r.opacity=1,r}return r._inheritsLoose(a,e),a}(i.NoParameters);function u(){const e=new t.ShaderBuilder;return e.include(a.ScreenSpacePass),e.fragment.uniforms.add(new l.Texture2DPassUniform("tex",(e=>e.texture))),e.fragment.uniforms.add(new o.IntegerPassUniform("overlayIdx",(e=>e.overlayIndex))),e.fragment.uniforms.add(new s.FloatPassUniform("opacity",(e=>e.opacity))),e.fragment.code.add(i.glsl`void main() {
