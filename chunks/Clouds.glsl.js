...
gl_FragColor = vec4(shading, totalTransmittance, shading, totalTransmittance);
}`),t}const w=n.create(),x=Object.freeze(Object.defineProperty({__proto__:null,CloudsDrawParameters:y,CloudsPassParameters:v,build:S},Symbol.toStringTag,{value:"Module"}));e.Clouds=x,e.CloudsDrawParameters=y,e.CloudsPassParameters=v,e.build=S}));
