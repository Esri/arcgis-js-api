...
define(["exports","../views/3d/webgl-engine/core/shaderModules/interfaces","../views/3d/webgl-engine/core/shaderLibrary/Transform.glsl","../views/3d/webgl-engine/core/shaderModules/ShaderBuilder","../views/3d/webgl-engine/core/shaderLibrary/Slice.glsl","../views/3d/webgl-engine/core/shaderLibrary/output/ReadLinearDepth.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/VisualVariables.glsl","../views/3d/webgl-engine/core/shaderLibrary/util/AlphaDiscard.glsl","../views/3d/webgl-engine/core/shaderLibrary/attributes/VerticalOffset.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/MultipassTerrainTest.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/ReadShadowMap.glsl","../views/3d/webgl-engine/core/shaderLibrary/ForwardLinearDepth.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/PhysicallyBasedRendering.glsl","../views/3d/webgl-engine/core/shaderLibrary/attributes/InstancedDoublePrecision.glsl","../views/3d/webgl-engine/core/shaderLibrary/attributes/TextureCoordinateAttribute.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/PhysicallyBasedRenderingParameters.glsl","../views/3d/webgl-engine/core/shaderLibrary/Offset.glsl","../views/3d/webgl-engine/core/shaderLibrary/attributes/NormalAttribute.glsl","../views/3d/webgl-engine/core/shaderLibrary/attributes/PositionAttribute.glsl","../views/3d/webgl-engine/core/shaderLibrary/attributes/SymbolColor.glsl","../views/3d/webgl-engine/core/shaderLibrary/attributes/VertexColor.glsl","../views/3d/webgl-engine/core/shaderLibrary/attributes/VertexNormal.glsl","../views/3d/webgl-engine/core/shaderLibrary/default/DefaultMaterialAuxiliaryPasses.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/ComputeNormalTexture.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/EvaluateAmbientOcclusion.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/EvaluateSceneLighting.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/Normals.glsl","../views/3d/webgl-engine/core/shaderLibrary/util/HeaderComment.glsl","../views/3d/webgl-engine/core/shaderLibrary/util/MixExternalColor.glsl"],(function(e,a,r,l,o,i,t,n,s,d,c,g,u,v,m,b,p,h,x,y,w,f,C,L,T,M,E,O,P){"use strict";function A(e){const A=new l.ShaderBuilder,S=A.vertex.code,D=A.fragment.code;return A.include(O.HeaderComment,{name:"Default Material Shader",output:e.output}),A.vertex.uniforms.add("proj","mat4").add("view","mat4").add("camPos","vec3").add("localOrigin","vec3"),A.include(x.PositionAttribute),A.varyings.add("vpos","vec3"),A.include(t.VisualVariables,e),A.include(v.InstancedDoublePrecision,e),A.include(s.VerticalOffset,e),0!==e.output&&7!==e.output||(A.include(h.NormalAttribute,e),A.include(r.Transform,{linearDepth:!1}),0===e.normalType&&e.offsetBackfaces&&A.include(p.Offset),A.include(L.ComputeNormalTexture,e),A.include(f.VertexNormal,e),e.instancedColor&&A.attributes.add("instanceColor","vec4"),A.varyings.add("localvpos","vec3"),A.include(m.TextureCoordinateAttribute,e),A.include(g.ForwardLinearDepth,e),A.include(y.SymbolColor,e),A.include(w.VertexColor,e),A.vertex.uniforms.add("externalColor","vec4"),A.varyings.add("vcolorExt","vec4"),e.multipassTerrainEnabled&&A.varyings.add("depth","float"),S.add(a.glsl`
      void main(void) {
        ...
        if (vcolorExt.a < ${a.glsl.float(n.symbolAlphaCutoff)}) {
    ...
    `)),A.include(C.DefaultMaterialAuxiliaryPasses,e),A}var S=Object.freeze({__proto__:null,build:A});e.DefaultMaterialShader=S,e.build=A}));
