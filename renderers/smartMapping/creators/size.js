...
define(["require","exports","../../../core/tsSupport/assignHelper","dojo/i18n!../../nls/smartMapping","../../../core/lang","../../../core/promiseUtils","../../../core/screenUtils","../../ClassBreaksRenderer","./support/ageUtils","./support/utils","../support/utils","../symbology/size","../../support/AuthoringInfo","../../support/AuthoringInfoVisualVariable","../../support/utils","../../visualVariables/SizeVariable"],function(e,r,a,i,l,n,t,s,o,u,d,m,p,c,y,v){function f(e){if(!(e&&e.layer&&(e.field||e.valueExpression||e.sqlExpression)))return n.reject(u.createError("size-visual-variable:missing-parameters","'layer' and 'field', 'valueExpression' or 'sqlExpression' parameters are required"));if(e.valueExpression&&!e.sqlExpression&&!e.view)return n.reject(u.createError("size-visual-variable:missing-parameters","View is required when 'valueExpression' is specified"));var r=a({},e),i=[0,1,2],l=d.createLayerAdapter(r.layer,i);return r.layer=l,l?l.load().then(function(){var e=l.geometryType;if("mesh"===e)return n.reject(u.createError("size-visual-variable:invalid-parameters","Size visualization is not applicable to layers with 'mesh' geometry type"));if(r.worldScale){if("polyline"===e||"polygon"===e)return n.reject(u.createError("size-visual-variable:not-supported","'worldScale' sizing is not supported for polyline and polygon layers"));if(!r.view||"3d"!==r.view.type)return n.reject(u.createError("size-visual-variable:invalid-parameters","'view' parameter should be an instance of SceneView when 'worldScale' parameter is true"))}var a=d.getFieldsList({field:r.field,normalizationField:r.normalizationField,valueExpression:r.valueExpression}),i=u.verifyBasicFieldValidity(l,a,"size-visual-variable:invalid-parameters");return i?n.reject(i):r}):n.reject(u.createError("size-visual-variable:invalid-parameters","'layer' must be one of these types: "+d.getLayerTypeLabels(i).join(", ")))}function b(e){if(!(e&&e.layer&&(e.field||e.valueExpression||e.sqlExpression)))return n.reject(u.createError("size-continuous-renderer:missing-parameters","'layer' and 'field', 'valueExpression' or 'sqlExpression' parameters are required"));if(e.valueExpression&&!e.sqlExpression&&!e.view)return n.reject(u.createError("size-continuous-renderer:missing-parameters","View is required when 'valueExpression' is specified"));var r=a({},e);r.symbolType=r.symbolType||"2d",r.defaultSymbolEnabled=null==r.defaultSymbolEnabled||r.defaultSymbolEnabled;var i=[0,1,2],l=d.createLayerAdapter(r.layer,i);return r.layer=l,l?l.load().then(function(){var e=l.geometryType,a=r.symbolType.indexOf("3d")>-1;if("mesh"===e)return n.reject(u.createError("size-continuous-renderer:invalid-parameters","Size visualization is not applicable to layers with 'mesh' geometry type"));if(a&&("polyline"===e||"polygon"===e))return n.reject(u.createError("size-continuous-renderer:not-supported","3d symbols are not supported for polyline and polygon layers"));if(r.symbolType.indexOf("3d-volumetric")>-1&&(!r.view||"3d"!==r.view.type))return n.reject(u.createError("size-continuous-renderer:invalid-parameters","'view' parameter should be an instance of SceneView when 'symbolType' parameter is '3d-volumetric' or 3d-volumetric-uniform"));var i=d.getFieldsList({field:r.field,normalizationField:r.normalizationField,valueExpression:r.valueExpression}),t=u.verifyBasicFieldValidity(l,i,"size-continuous-renderer:invalid-parameters");return t?n.reject(t):r}):n.reject(u.createError("size-continuous-renderer:invalid-parameters","'layer' must be one of these types: "+d.getLayerTypeLabels(i).join(", ")))}function h(e){if(!e||!e.layer||!e.field&&!e.valueExpression)return n.reject(u.createError("size-class-breaks-renderer:missing-parameters","'layer' and 'field' or 'valueExpression' parameters are required"));if(e.valueExpression&&!e.view)return n.reject(u.createError("size-class-breaks-renderer:missing-parameters","View is required when 'valueExpression' is specified"));var r=a({},e);r.symbolType=r.symbolType||"2d",r.defaultSymbolEnabled=null==r.defaultSymbolEnabled||r.defaultSymbolEnabled,r.classificationMethod=r.classificationMethod||"equal-interval",r.normalizationType=d.getNormalizationType(r);var i=[0,1,2],l=d.createLayerAdapter(r.layer,i);return r.layer=l,l?null!=r.minValue&&null!=r.maxValue||null==r.minValue&&null==r.maxValue?l.load().then(function(){var e=l.geometryType,a=r.symbolType.indexOf("3d")>-1;if("mesh"===e)return n.reject(u.createError("size-class-breaks-renderer:invalid-parameters","Size visualization is not applicable to layers with 'mesh' geometry type"));if(a&&("polyline"===e||"polygon"===e))return n.reject(u.createError("size-class-breaks-renderer:not-supported","3d symbols are not supported for polyline and polygon layers"));if(r.symbolType.indexOf("3d-volumetric")>-1&&(!r.view||"3d"!==r.view.type))return n.reject(u.createError("size-class-breaks-renderer:invalid-parameters","'view' parameter should be an instance of SceneView when 'symbolType' parameter is '3d-volumetric' or 3d-volumetric-uniform"));var i=d.getFieldsList({field:r.field,normalizationField:r.normalizationField}),t=u.verifyBasicFieldValidity(l,i,"size-class-breaks-renderer:invalid-parameters");return t?n.reject(t):r}):n.reject(u.createError("size-class-breaks-renderer:missing-parameters","Both 'minValue' and 'maxValue' are required when specifying custom data range")):n.reject(u.createError("size-class-breaks-renderer:invalid-parameters","'layer' must be one of these types: "+d.getLayerTypeLabels(i).join(", ")))}function g(e){var r=a({},e);delete r.basemap,delete r.sizeScheme,delete r.legendOptions,delete r.symbolType,delete r.defaultSymbolEnabled;var i=r;return i.analyzeData=!(null!=r.minValue&&null!=r.maxValue),i}function z(e){var r=a({},e),i=r.symbolType.indexOf("3d-volumetric")>-1,l=r;return l.worldScale=i,i&&(l.axis="3d-volumetric-uniform"===r.symbolType?"all":"height"),delete r.symbolType,delete r.defaultSymbolEnabled,l}function E(e){if(!(e&&e.layer&&e.view&&e.startTime&&e.endTime))return n.reject(u.createError("size-age-renderer:missing-parameters","'layer', 'view', 'startTime', 'endTime' parameters are required"));var r=a({},e);r.symbolType=r.symbolType||"2d",r.defaultSymbolEnabled=null==r.defaultSymbolEnabled||r.defaultSymbolEnabled;var i=[0,1,2],l=d.createLayerAdapter(r.layer,i);return r.layer=l,l?l.load().then(function(){var e=l.geometryType,a=r.symbolType.indexOf("3d")>-1;if("mesh"===e)return n.reject(u.createError("size-age-renderer:invalid-parameters","Size visualization is not applicable to layers with 'mesh' geometry type"));if(a&&("polyline"===e||"polygon"===e))return n.reject(u.createError("size-age-renderer:not-supported","3d symbols are not supported for polyline and polygon layers"));if(r.symbolType.indexOf("3d-volumetric")>-1&&(!r.view||"3d"!==r.view.type))return n.reject(u.createError("size-age-renderer:invalid-parameters","'view' parameter should be an instance of SceneView when 'symbolType' parameter is '3d-volumetric' or 3d-volumetric-uniform"));var i=o.verifyDates(l,r.startTime,r.endTime,"size-age-renderer:invalid-parameters");return i?n.reject(i):r.unit&&-1===o.supportedAgeUnits.indexOf(r.unit)?n.reject(u.createError("size-age-renderer:invalid-unit","Supported units are: "+o.supportedAgeUnits.join(", "))):r}):n.reject(u.createError("size-age-renderer:invalid-parameters","'layer' must be one of these types: "+d.getLayerTypeLabels(i).join(", ")))}function S(e){var r=e.sizeScheme,a=e.basemap;if(r)r=m.cloneScheme(r);else{var i=m.getSchemes({basemap:e.basemap,geometryType:e.geometryType,worldScale:e.worldScale,view:e.view});r=i&&i.primaryScheme,a=i&&i.basemapId}return{scheme:r,basemapId:a}}function x(e,r){var a;switch(r){case"point":case"multipoint":var i=e;a=[i.minSize,i.maxSize];break;case"polyline":var l=e;a=[l.minWidth,l.maxWidth];break;case"polygon":var n=e;a=[n.marker.minSize,n.marker.maxSize]}return a}function T(e,r,a){var i=a.layer,l=a.field,t="function"==typeof l,s=l&&!t?i.getField(l):null,o=s&&s.type===L,d=i.geometryType,y=S({basemap:a.basemap,geometryType:d,sizeScheme:a.sizeScheme,worldScale:a.worldScale,view:a.view}),f=y.scheme;if(!f)return n.reject(u.createError("size-visual-variable:insufficient-info","Unable to find size scheme"));var b=x(f,d),h=u.getDefaultDataRange(e,o,!1),g=h||[e.min,e.max],z=[],E="height"===a.axis,T=E?a.axis:void 0,w=b[0],V=b[1];if(E){var j=u.getSizeRangeForAxis({minSize:w,maxSize:V},T);z.push(new v({axis:"width-and-depth",minSize:j.minSize})),V=j.maxSize}z.unshift(new v({field:l,valueExpression:a.valueExpression,valueExpressionTitle:a.valueExpressionTitle,valueUnit:"unknown",normalizationField:r,axis:T,minSize:w,maxSize:V,minDataValue:g[0],maxDataValue:g[1],legendOptions:a.legendOptions}));var k=new c({type:"size",minSliderValue:e.min,maxSliderValue:e.max}),F=new p({visualVariables:[k]});return n.resolve({basemapId:y.basemapId,visualVariables:z,statistics:e,defaultValuesUsed:!!h,sizeScheme:m.cloneScheme(f),authoringInfo:F})}function w(e,r,a,l){var n=l.layer,t=l.field,o=n.geometryType,d=l.defaultSymbolEnabled,p=m.cloneScheme(e.sizeScheme),c="polygon"===o,y=c?p.marker:p,v=c?p.background:null,f="polyline"===o?y.noDataWidth:y.noDataSize,b=v?u.createSymbol(v,v.color,o,l.symbolType):null;return{renderer:new s({backgroundFillSymbol:b,classBreakInfos:[{minValue:-D,maxValue:D,symbol:u.createSymbol(y,y.color,c?"point":o,l.symbolType)}],defaultLabel:d?i.other:null,defaultSymbol:d?u.createSymbol(y,y.noDataColor,c?"point":o,l.symbolType,null,null,f):null,field:t,normalizationField:a,normalizationType:r,valueExpression:l.valueExpression,valueExpressionTitle:l.valueExpressionTitle,visualVariables:e.visualVariables.map(function(e){return e.clone()}),authoringInfo:e.authoringInfo&&e.authoringInfo.clone()}),visualVariables:e.visualVariables.map(function(e){return e.clone()}),statistics:e.statistics,defaultValuesUsed:e.defaultValuesUsed,sizeScheme:m.cloneScheme(e.sizeScheme),basemapId:e.basemapId}}function V(e,r,a){for(var i=x(e,r),l=t.toPt(i[0]),n=t.toPt(i[1]),s=(n-l)/(a>=4?a-1:a),o=[],u=0;u<a;u++)o.push(l+s*u);return o}function j(e,r){var a=e.layer,l=e.defaultSymbolEnabled,t=a.geometryType,o="polygon"===t,d=S({basemap:e.basemap,geometryType:t,sizeScheme:e.sizeScheme,worldScale:e.symbolType.indexOf("3d-volumetric")>-1,view:e.view}),c=d.scheme,v=r.result,f=v.classBreakInfos,b=e.classificationMethod,h=e.normalizationType,g=V(c,t,f.length),z=o?c.marker:c,E=o?c.background:null,x="polyline"===t?z.noDataWidth:z.noDataSize,T=new s({backgroundFillSymbol:E?u.createSymbol(E,E.color,t,e.symbolType):null,classBreakInfos:f.map(function(r,a){return{minValue:r.minValue,maxValue:r.maxValue,symbol:u.createSymbol(z,z.color,o?"point":t,e.symbolType,null,null,g[a]),label:r.label}}),defaultLabel:l?i.other:null,defaultSymbol:l?u.createSymbol(z,z.noDataColor,o?"point":t,e.symbolType,null,null,x):null,field:e.field,valueExpression:e.valueExpression,valueExpressionTitle:e.valueExpressionTitle,normalizationType:h,normalizationField:e.normalizationField,normalizationTotal:"percent-of-total"===h?v.normalizationTotal:void 0,legendOptions:e.legendOptions,authoringInfo:new p({type:"class-breaks-size",classificationMethod:b,standardDeviationInterval:e.standardDeviationInterval})});return"standard-deviation"!==b&&y.setLabelsForClassBreaks({classBreakInfos:T.classBreakInfos,classificationMethod:b,normalizationType:h,round:!0}),n.resolve({renderer:T,sizeScheme:m.cloneScheme(c),classBreaksResult:v,defaultValuesUsed:r.defaultValuesUsed,basemapId:d.basemapId})}function k(e){return f(e).then(function(e){var r,a=e.normalizationField,i=a?"field":void 0;return r=e.statistics?n.resolve(e.statistics):u.getSummaryStatistics({layer:e.layer,field:e.field,valueExpression:e.valueExpression,sqlExpression:e.sqlExpression,sqlWhere:e.sqlWhere,normalizationType:i,normalizationField:a,minValue:e.minValue,maxValue:e.maxValue,view:e.view}),r.then(function(r){return T(r,a,e)})})}function F(e){return b(e).then(function(e){return k(z(e)).then(function(r){var a=e.normalizationField;return w(r,a?"field":void 0,a,e)})})}function I(e){return h(e).then(function(e){return u.getClassBreaks(g(e)).then(function(r){return j(e,r)})})}function q(e){return E(e).then(function(e){var r=e.defaultSymbolEnabled,t=e.view,s=e.layer,u=e.startTime,d=e.endTime,m=e.symbolType;return(e.unit?n.resolve({unit:e.unit,statistics:null,valueExpression:null}):o.getSuggestedAgeUnit({view:t,layer:s,startTime:u,endTime:d})).then(function(n){var t=n.unit,p=n.statistics,c=n.valueExpression,y=c||o.getAgeExpressions({layer:s,startTime:u,endTime:d,unit:t}).valueExpression,v=l.substitute({unit:t,startTime:o.formatDate(u,t,s),endTime:o.formatDate(d,t,s)},i["ageInfo_"+t]);return k(z({layer:s,basemap:e.basemap,valueExpression:y,symbolType:m,statistics:p,legendOptions:{title:v},sizeScheme:e.sizeScheme,view:e.view})).then(function(e){var i=w(e,null,null,{layer:s,valueExpression:y,defaultSymbolEnabled:r,symbolType:m});return a({},i,{unit:t})})})})}Object.defineProperty(r,"__esModule",{value:!0});var L="date",D=Math.pow(2,53)-1;r.createVisualVariables=k,r.createContinuousRenderer=F,r.createClassBreaksRenderer=I,r.createAgeRenderer=q});