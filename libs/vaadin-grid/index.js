...
/**
   ...
   * rights grant found at http://polymer.github.io/PATENTS.txt
   */
const Ps=/:host\(:dir\((ltr|rtl)\)\)/g,Es=/([\s\w-#\.\[\]\*]*):dir\((ltr|rtl)\)/g,Ts=/:dir\((?:ltr|rtl)\)/,Is=Boolean(window.ShadyDOM&&window.ShadyDOM.inUse),Os=[];let zs=null,Rs="";function Ns(){Rs=document.documentElement.getAttribute("dir")}function ks(e){if(!e.__autoDirOptOut){e.setAttribute("dir",Rs)}}function Ls(){Ns(),Rs=document.documentElement.getAttribute("dir");for(let e=0;e<Os.length;e++)ks(Os[e])}const Ds=fe(e=>{Is||zs||(Ns(),zs=new MutationObserver(Ls),zs.observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]}));const t=qe(e);class i extends t{static _processStyleText(e,i){return e=t._processStyleText.call(this,e,i),!Is&&Ts.test(e)&&(e=this._replaceDirInCssText(e),this.__activateDir=!0),e}static _replaceDirInCssText(e){let t=e;return t=t.replace(Ps,':host([dir="$1"])'),t=t.replace(Es,':host([dir="$2"]) $1'),t}constructor(){super(),this.__autoDirOptOut=!1}ready(){super.ready(),this.__autoDirOptOut=this.hasAttribute("dir")}connectedCallback(){t.prototype.connectedCallback&&super.connectedCallback(),this.constructor.__activateDir&&(zs&&zs.takeRecords().length&&Ls(),Os.push(this),ks(this))}disconnectedCallback(){if(t.prototype.disconnectedCallback&&super.disconnectedCallback(),this.constructor.__activateDir){const e=Os.indexOf(this);e>-1&&Os.splice(e,1)}}}return i.__activateDir=!1,i});
/**
  @license
  Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
  This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
/**
  ...
  subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
  */
let kr=!1;function Lr(){if(L&&!T){if(!kr){kr=!0;const e=document.createElement("style");e.textContent="dom-bind,dom-if,dom-repeat{display:none;}",document.head.appendChild(e)}return!0}return!1}
/**
  @license
  Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
  This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
