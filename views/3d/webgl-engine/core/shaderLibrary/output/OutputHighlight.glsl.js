...
}`)}function h(e,i){e.bindTexture(i.highlightDepthTexture,"depthTex"),e.setUniform4f("highlightViewportPixelSz",0,0,i.inverseViewport[0],i.inverseViewport[1])}e.OutputHighlight=o,e.bindOutputHighlight=h,e.occludedHighlightFlag=g,e.unoccludedHighlightFlag=l,Object.defineProperties(e,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})}));
