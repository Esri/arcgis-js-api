  ...
  void forwardTextureCoordinatesWithTransform(in vec2 uv) {
    ...
    vec4 getColor(vec4 color, vec2 uv, vec3 opacities) {
      ${u||c?a.glsl`
              ...
              vec4 bg = ${c?a.glsl`vec4(backgroundColor, 1.0)`:a.glsl`gridColor(uv)`} * opacities.y;
              float alpha = opacities.z * color.a;
              return mix(bg, color, alpha) * opacities.x;`:a.glsl`return color;`}
...
}`)}let v=function(e){function r(t){return e.call(this,t,"float")||this}return t._inheritsLoose(r,e),r}(c.Uniform),x=function(e){function r(t){return e.call(this,t,"vec3")||this}return t._inheritsLoose(r,e),r}(c.Uniform),g=function(e){function r(t){return e.call(this,t,"vec4")||this}return t._inheritsLoose(r,e),r}(c.Uniform),m=function(e){function r(t){return e.call(this,t,"sampler2D")||this}return t._inheritsLoose(r,e),r}(c.Uniform);e.Float3Uniform=x,e.OverlayTerrain=d,e.OverlayTerrainPassParameters=u,e.TerrainTexture=f,e.Texture2DUniform=m,Object.defineProperties(e,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})}));
