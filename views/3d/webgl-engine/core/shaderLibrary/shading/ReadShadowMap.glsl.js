...
*/
define(["exports","../../../../../../chunks/_rollupPluginBabelHelpers","../../../../../../chunks/vec3f64","../util/RgbaFloatEncoding.glsl","../util/WebGL2Utils","../../shaderModules/Float4PassUniform","../../shaderModules/IntegerPassUniform","../../shaderModules/interfaces","../../shaderModules/Matrix4sDrawUniform","../../shaderModules/Matrix4sPassUniform","../../shaderModules/Texture2DPassUniform","../../shaderModules/TextureSizeUniformType"],(function(e,a,s,t,o,i,r,d,l,n,c,p){"use strict";let h=function(e){function t(){var a;return(a=e.apply(this,arguments)||this).origin=s.create(),a}return a._inheritsLoose(t,e),t}(d.NoParameters);function u(e,a){a.receiveShadows&&(e.fragment.uniforms.add(new n.Matrix4sPassUniform("shadowMapMatrix",((e,a)=>a.shadowMap.getShadowMapMatrices(e.origin)),4)),f(e,a))}function v(e,a){a.receiveShadows&&(e.fragment.uniforms.add(new l.Matrix4sDrawUniform("shadowMapMatrix",((e,a)=>a.shadowMap.getShadowMapMatrices(e.origin)),4)),f(e,a))}function f(e,a){const s=e.fragment;s.include(t.RgbaFloatEncoding),s.uniforms.add([...c.createTexture2DPassSizeUniforms("shadowMapTex",((e,a)=>a.shadowMap.depthTexture),a.hasWebGL2Context?p.TextureSizeUniformType.None:p.TextureSizeUniformType.Size),new r.IntegerPassUniform("numCascades",((e,a)=>a.shadowMap.numCascades)),new i.Float4PassUniform("cascadeDistances",((e,a)=>a.shadowMap.cascadeDistances))]),s.code.add(d.glsl`
  ...
  `)}e.ReadShadowMapBindParameters=h,e.ReadShadowMapDraw=v,e.ReadShadowMapPass=u,Object.defineProperties(e,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})}));
