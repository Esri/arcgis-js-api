...
vec2 result = (ij * 2.0 - vec2(1.0)) * clipCoord.w;
return vec4(result, clipCoord.zw);
}`;e.vertex.code.add(c),e.vertex.code.add(o),e.fragment.code.add(c),e.fragment.code.add(o)}e.AlignPixel=c,Object.defineProperty(e,Symbol.toStringTag,{value:"Module"})}));
