...
*/
define(["exports","../../../../../../core/compilerUtils","../../../core/shaderModules/interfaces","../../../lib/VertexAttribute","./EdgeUtil.glsl"],(function(e,t,n,s,i){"use strict";function o(e,o){const d=e.vertex;switch(e.include(i.EdgeUtil,o),e.attributes.add(s.VertexAttribute.SIDENESS,"vec2"),o.mode===i.EdgeUtilMode.MIXED?d.code.add(n.glsl`struct UnpackedAttributes {
vec2 sideness;
vec2 sidenessNorm;
