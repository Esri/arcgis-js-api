...
*/
define(["exports","../../../../core/shaderModules/interfaces"],(function(e,c){"use strict";function i(e,i){const t=e.vertex;switch(t.code.add(c.glsl`
  ...
  `),i.vertexDiscardMode){case 0:t.code.add(c.glsl`
      ...
      `);break;case 1:t.code.add(c.glsl`
        #define vertexDiscardByOpacity(_opacity_) { if (_opacity_ <= VERTEX_DISCARD_CUTOFF) {  gl_Position = vec4(1e38, 1e38, 1e38, 1.0); return; } }
      `)}}e.VertexDiscardByOpacity=i,Object.defineProperty(e,"__esModule",{value:!0})}));
