 ...
 * (e.g. under the mouse pointer) was in shadow during a shadow cast analysis.
 */
@subclass("esri.widgets.ShadowCast.components.ShadowTooltipContent")
export class ShadowTooltipContent extends Widget implements ConstructProperties {
  ...
  private _messages: Maybe<ShadowCastMessages> = null;
