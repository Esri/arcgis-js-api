...
define(["require","exports","../core/tsSupport/declareExtendsHelper","../core/tsSupport/decorateHelper","../core/accessorSupport/decorators","./support/widget","./Widget","./Attribution/AttributionViewModel"],function(e,t,i,r,o,s,n,a){var c={base:"esri-attribution esri-widget",poweredBy:"esri-attribution__powered-by",sources:"esri-attribution__sources",open:"esri-attribution--open",sourcesOpen:"esri-attribution__sources--open",link:"esri-attribution__link",interactive:"esri-interactive"},d=function(e){function t(t){var i=e.call(this)||this;return i._isOpen=!1,i._attributionTextOverflowed=!1,i._prevSourceNodeHeight=0,i.view=null,i.viewModel=new a,i}return i(t,e),t.prototype.render=function(){var e=(t={},t[c.open]=this._isOpen,t);return s.tsx("div",{bind:this,"class":c.base,classes:e,onclick:this._toggleState,onkeydown:this._toggleState},this._renderSourcesNode(),s.tsx("div",{"class":c.poweredBy},"Powered by ",s.tsx("a",{target:"_blank",href:"http://www.esri.com/","class":c.link},"Esri")));var t},t.prototype._renderSourcesNode=function(){var e=this._isOpen,t=this._isInteractive(),i=t?0:-1,r=this.get("viewModel.attributionText"),o=t?"button":void 0,n=(a={},a[c.sourcesOpen]=e,a[c.interactive]=t,a);return s.tsx("div",{afterCreate:this._afterSourcesNodeCreate,afterUpdate:this._afterSourcesNodeUpdate,bind:this,"class":c.sources,classes:n,innerHTML:r,role:o,tabIndex:i});var a},t.prototype._afterSourcesNodeCreate=function(e){this._prevSourceNodeHeight=e.clientWidth},t.prototype._afterSourcesNodeUpdate=function(e){var t=!1,i=e.clientHeight,r=e.clientWidth,o=e.scrollWidth,s=o>=r,n=this._attributionTextOverflowed!==s;if(this._attributionTextOverflowed=s,n&&(t=!0),this._isOpen){var a=i<this._prevSourceNodeHeight;this._prevSourceNodeHeight=i,a&&(this._isOpen=!1,t=!0)}t&&this.scheduleRender()},t.prototype._toggleState=function(){this._isInteractive()&&(this._isOpen=!this._isOpen)},t.prototype._isInteractive=function(){return this._isOpen||this._attributionTextOverflowed},t}(o.declared(n));return r([o.aliasOf("viewModel.view")],d.prototype,"view",void 0),r([o.property({type:a}),s.renderable(["attributionText","state","view.size"])],d.prototype,"viewModel",void 0),r([s.accessibleHandler()],d.prototype,"_toggleState",null),d=r([o.subclass("esri.widgets.Attribution")],d)});